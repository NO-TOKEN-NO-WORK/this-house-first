 ...
 *
 * 캘리브레이션 (2026-08-23, 시드 실데이터: 경북 포항시 북구 죽도동 건축물대장 10동 × 합성 15명):
 *   비상일  심각 4 · 경계 6 · 주의 5   ← 심각 = 전화 생략·방문 대상. 담당자 방문 처리 능력 ~4가구/일(PRD P3) 이내
 *   경계일  심각 2 · 경계 5 · 주의 8
 *   주의일  심각 1 · 경계 3 · 주의 11
 *   점수 범위: 63(86세·독거·거동불편·1978 벽돌 단독주택) ~ 3.5(66세·2007 단독주택). 경계 근처: 23.6 / [25] / 31.5, 7.5 / [10] / 10.5

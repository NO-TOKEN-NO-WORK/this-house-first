...
| [0020](0020-welfare-scan-luna-responses.md) | 복지 스캔: Luna 신호 추출 + 규칙 기반 자격 판정 | 부분 대체됨([0023](0023-vercel-ai-gateway-luna.md), [0024](0024-subject-context-briefing.md)) |
...
| [0024](0024-subject-context-briefing.md) | 대상자 맥락 브리핑: 근거 인용 강제 + 위험도 미개입 | 승인됨 |
